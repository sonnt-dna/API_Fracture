...
for alpha in range (0.,1.,10):
    beta = 1-alpha
    for threshold in range (0.2,0.8,5):
        FNR, FPR, df_new = matrix_calculation(alpha=alpha, beta=beta, threshold=threshold)
        possible_alpha_list[threshold] = [alpha, FNR, FPR]