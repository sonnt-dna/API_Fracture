from xgboost_dlc.optuna_xgboost import Train_XGB
from xgboost_dlc.score_cal import Score
...
# set scoring
scoring='precision'
model = Train_XGB(features=X_train,
               labels=y_train,
               iterations=10,
               scoring=scoring,
               validation_size=0.1,
...
y_pred=model.predict(xgb.DMatrix(X_test, label=y_test)) >= 0.5
